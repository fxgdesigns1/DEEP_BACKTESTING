"""
OVERNIGHT FUTURES OPTIMIZATION - MASTER SCRIPT
Runs complete optimization while you sleep
World-class autonomous trading system optimization
"""
...
class OvernightOptimizer:
    ...
    def run_command(self, command, phase_name):
        ...
        try:
            ...
            self.log(f"\n⏱️ {phase_name} timed out after 2 hours")
    ...
    def run_overnight(self):
        ...
        if not phase2_success:
            self.log("\n⚠️ Optimization had issues but may have partial results")
        ...
        if results_dirs:
            ...
            if report_file.exists():
                ...
                self.log("\n⚠️ Report file not found - check results manually")
        else:
